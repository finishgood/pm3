                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Closing Export Container</h5>
                                                    </div>
                                                                ...
                                                                <tbody>
                                                                    <template x-for="(exportData,index) in tableExport" >
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <a><span :class="exportData.PGI ? 'icofont-check' : 'icofont-envelope-open'" class="icofont" @click="updateItem(index)"></span></a>
                                                                            </td>
                                                                        </tr>
                                                                    </template>
                                                                </tbody>
            ...
            return {
                ...
                async getData(){
                    ...
                    try{
                        ...
                        let url = serverHosting + "/boc/outstanding"
                        let postBody = { 
                ...
                async updateItem(index){
                    ...
                    this.NoDN = this.tableExport[index].NoDN
                   console.log(this.tableExport[index])

                   try{
                            Alpine.store('globVar').isLoading = true
                            const submitDataForm = {}
                            submitDataForm.NoDN =  this.NoDN 
                            console.log(submitDataForm)
                            let url = serverHosting + "/boc/pgi"
                            const data = await (await fetch(url, { method: 'POST', 
                                headers: {'Content-Type': 'application/json'},
