            ...
            <div class="pcoded-wrapper">
                ...
                <div class="pcoded-content">
                    ...
                    <div class="pcoded-inner-content">
                        <div class="main-body">
                            <div class="page-wrapper" x-data="showSelongsong()">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Cetak Selongsong</h5>
                                                    </div>
                                                    <div class="card-block">
                                                        
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Nomor IML</label>
                                                            <div class="col-sm-3">
                                                                    <input id="txt_noIML" x-model="noIML" type="number" class="form-control">
                                                            </div>
                                                            
                                                            <div class="col-sm-2">
                                                                <button @click="window.open('assets/pages/form/cetakformselongsong.html?id='+noIML, '_blank')"  class="btn waves-effect waves-light btn-primary">
                                                                    <span class="icofont icofont-print"> Cetak</span>
                                                                </button>
                                                            </div>
                                                        </div>
